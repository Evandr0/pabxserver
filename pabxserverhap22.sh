...
echo -e "\n"
echo -e "**************************************************************"
echo -e "*  Welcome to the Pabxserver high availability installation  *"
...
echo -e "*                     ./pabxserverha.sh rebuild                            *"
echo -e "****************************************************************************"
...
echo -e "*   Creating Firewall Services in Pabxserver in Server 1     *"
echo -e "************************************************************"
...
echo -e "************************************************************"
echo -e "*             Configuring Permanent Firewall               *"
echo -e "*     Creating Firewall Rules in Pabxserver in Server 1      *"
echo -e "************************************************************"
...
scp -P /usr/local/bin/bascul root@$ip_standby:/usr/local/bin/bascul
...
echo -e "************************************************************"
echo -e "*         Creating PABXSERVER Cluster role Command           *"
echo -e "************************************************************"
